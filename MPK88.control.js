...
host.defineController("Akai", "MPK88", "1.0", "8E230CA0-B9F3-11E3-A5E2-0800200C9A66");
host.defineSysexIdentityReply("F0 7E 00 06 02 47 71 00  19 00 ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? F7");
...
function init()
{
  host.getMidiInPort(0).createNoteInput("MPK88 Keyboard", "80????", "90????", "B001??", "B040??", "D0????", "E0????");
  host.getMidiInPort(0).createNoteInput("MPK88 Pads", "81????", "91????", "D1????");
